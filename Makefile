PGMS=mmult_omp_timing nParammultNS SIMDmultNS SIMDmult automation nParammult matrix_times_vector hello pi mxv_omp_mpi mmult_mpi_omp OMPmmult
...
OMPmmult:	OMPmmult.c
	gcc -o OMPmmult -fopenmp -O3 OMPmmult.c
